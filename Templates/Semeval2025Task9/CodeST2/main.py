...
def main():
    ...
    parser.add_argument("--save_path", default="/content/drive/MyDrive/Templates/Semeval2025Task9/Data/checkpoint_product", type=str)
    ...
    parser.add_argument("--num_class", type=int, default=1068)
    ...
    if args.load_path_h == "":  # Training
        ...
        test_df['product'] = product_preds
        test_df[['hazard', 'product']].to_csv('submissionST2.csv')
